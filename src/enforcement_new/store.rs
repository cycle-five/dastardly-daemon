...
use crate::enforcement_new::{
    EnforcementError, EnforcementRecord, EnforcementResult, EnforcementState,
};
use chrono::Utc;
use dashmap::DashMap;
use std::sync::Arc;
...
impl EnforcementStore {
    ...
    pub fn get(
        &self,
        id: &str,
    ) -> Option<dashmap::mapref::one::Ref<'_, String, EnforcementRecord>> {
        self.records.get(id)
    }
    ...
    pub fn get_mut(
        &self,
        id: &str,
    ) -> Option<dashmap::mapref::one::RefMut<'_, String, EnforcementRecord>> {
...
mod tests {
    ...
    fn test_get_for_user() {
        ...
        let record1 =
            EnforcementRecord::new("warning-1", 12345, 67890, EnforcementAction::mute(300));
        ...
        let record3 =
            EnforcementRecord::new("warning-3", 98765, 67890, EnforcementAction::mute(300));
